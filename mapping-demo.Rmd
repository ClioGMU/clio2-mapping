...
Markers are not very interesting. We want to set the radius of the circle to the square root of the population. We have to write our own function to . (All of these concepts were introduced in the worksheets for this very purpose; I was not *just* torturing you.)
...
See the examples in Kieran Healy's book on data visualization for using ggplot2 to make static maps.
